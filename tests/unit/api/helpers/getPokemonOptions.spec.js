import getPokemonsOptions, { getPokemons, getPokemonsNames } from '@/assets/helpers/getPokemonOptions'
...
describe('getPokemonOptions helpers', () => {
    ...
    test('debe de retornar un arreglo de 4 alementos con nombres de pokemons', async () => {
